...
class CorefModel(object):
  def __init__(self, config):
    ...
    self.W = tf.get_variable("word_embeddings", [len(self.word_emb.char2ids), 300],
                               initializer=tf.truncated_normal_initializer(stddev=0.02), trainable=True, dtype=tf.float32)
  ...
  def get_predictions_and_loss(self, input_ids, input_mask, text_len, speaker_ids, genre, is_training, gold_starts, gold_ends, cluster_ids, sentence_map):
    ...
    mention_doc = self.embedded_chars
