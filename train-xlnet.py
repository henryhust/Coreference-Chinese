  ...
  with tf.Session() as session:
    ...
    while True:
        ...
        if tf_global_step > 0 and tf_global_step % eval_frequency == 0:
            eval_summary, eval_f1, eval_p, eval_r = model.evaluate(session, tf_global_step, mod="eval")
            ...
            logger.info("[{}] evaL_f1={:.4f}, evaL_p={:.4f}, evaL_r={:.4f}, max_f1={:.4f}"
                        .format(tf_global_step, eval_f1, eval_p, eval_r, max_f1))
